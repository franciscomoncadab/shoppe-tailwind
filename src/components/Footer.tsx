    ...
    <footer>
      ...
      <hr className="my-6 border-gray sm:mx-auto" />
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <div className="flex mt-2 mb-4 space-x-6 sm:justify-center sm:mt-0">
          <a
              href="."
          ...
          <span className="text-sm text-dark-gray sm:text-center dark:text-gray-400">
            
            <a href="." className="text-dark-gray hover:underline">
            © 2021{" "}Shelly
            </a>
            . Terms of use <a href="." className="text-dark-gray" >and</a> privacy policy.
          </span>
        </div>
      </div>
    </footer>
